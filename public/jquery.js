$(function (){
    ...
    //a new row html
    row = "<tr class='unit-row'><td><button class='delete-line'> - </button></td><td id=unit> </td><td> <input type='text' class='unit_code' placeholder='e.g. ETF1100' size='7'> </td> <td> <input type='number' class='mark' placeholder='e.g. 65' size='3'></td> <td> <select name='credit_points'> <option value='6'>6</option> <option value='12'>12</option> <option value='18'>18</option> <option value='24'>24</option></select></td></tr>"
